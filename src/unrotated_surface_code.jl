...
"""
    decode_unrotated_surface_rectangular_GKP_code(ξ::Vector, 
    unrotated_surface_code_x_stabilizers::Dict{String, Dict{Int64, Vector{Int64}}},
    unrotated_surface_code_z_stabilizers::Dict{String, Dict{Int64, Vector{Int64}}},
    η::Vector
    )
...
Decode the surface-GKP code for an input vector ξ. 
    ...
    Inputs:
        ξ: The input vector
        unrotated_surface_code_x_stabilizers: The X stabilizers for the stabilizer GKP code
        unrotated_surface_code_z_stabilizers: The Z stabilizers for the stabilizer GKP code
...
"""
function decode_unrotated_surface_rectangular_GKP_code(
    ξ::Vector, 
    unrotated_surface_code_x_stabilizers::Dict{Int64, Vector{Int64}},
    unrotated_surface_code_z_stabilizers::Dict{Int64, Vector{Int64}},
    η::Vector
)
    ξ_q = ξ[1:2:end]
    ξ_p = ξ[2:2:end]
    ...
    y_q, final_list_q = decode_concatenated_rectangular_GKP_code(ξ_q, unrotated_surface_code_z_stabilizers, η_q)
    y_p, final_list_p = decode_concatenated_rectangular_GKP_code(ξ_p, unrotated_surface_code_x_stabilizers, η_p)
...
"""
    decode_unrotated_surface_code(ξ::Vector, 
    unrotated_surface_code_x_stabilizers::Dict{String, Dict{Int64, Vector{Int64}}},
    unrotated_surface_code_z_stabilizers::Dict{String, Dict{Int64, Vector{Int64}}}
    )
...
"""
decode_unrotated_surface_code(
    ξ::Vector, 
    unrotated_surface_code_x_stabilizers::Dict{Int64, Vector{Int64}},
    unrotated_surface_code_z_stabilizers::Dict{Int64, Vector{Int64}}
) = decode_unrotated_surface_rectangular_GKP_code(ξ, 
    unrotated_surface_code_x_stabilizers,
    unrotated_surface_code_z_stabilizers,
    ones(length(ξ))
)
